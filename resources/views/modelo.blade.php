        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-7 col-md-pull-5">
                    <h2 class="topmargin_0 bottommargin_30">{{ $usuario->nombre }} - <div class="highlight inline-block fontsize_30 thin"><a title="Click para chatear" href="{{ $usuario->linkWhatsapp }}" target="_blank" rel="noopener"><img src="{{ asset('general/images/whatsapp.png') }}" height="30px" width="30px" alt=""> {{ $usuario->celular }}</a></div> - {{ $usuario->cantidadValoraciones }} valoracion(es)</h2>
