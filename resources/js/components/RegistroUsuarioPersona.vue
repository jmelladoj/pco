                ...
                <div class="col-xs-offset-2 col-xs-8 col-md-offset-2 col-md-8 col-lg-offset-3 col-lg-6 text-center">
                    ...
                    <form class="form">                      
                        <div class="form-group">
                            ...
                            <input type="text" aria-required="true" size="30" v-model="usuario" class="form-control text-center" placeholder="Usuario" v-validate.continues="'required'" name="usuario" data-vv-scope="registro_usuario_persona">
                        </div>
                        <div class="form-group">
                            <label for="name" class="sr-only">Contraseña
                                <span class="required">*</span>
                            </label>
                            <input type="password" aria-required="true" size="30" v-model="clave" class="form-control text-center" placeholder="Contraseña" v-validate.continues="'required|min:8'" data-vv-as="Contraseña" data-vv-scope="registro_usuario_persona">
                        </div>
                        <div class="form-group">
                            <select v-model="sexo" class="form-control" v-validate.continues="'required|included:1,2'" data-vv-as="Sexo" data-vv-scope="registro_usuario_persona">
