            ...
            <div class="container-fluid">
                <div class="row bottommargin_50 boxed-padding">
                    <div class="col-lg-12 text-lg-right">
                        <h2 class="muellerhoff topmargin_5 bottommargin_50 highlight">ÚLTIMAS PUBLICACIONES</h2>
                    </div>
                </div>
...
<script>
    export default {
        ...
        methods:{
            listarUsuarios (){
                let me=this;
                axios.get('/usuarios/normal').then(function (response) {
...
#user-online .vertical-item.content-absolute {
