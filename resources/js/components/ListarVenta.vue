<template>
    <section v-show="usuarios.length > 0" class="ds page_models models_square gorizontal_padding section_padding_70 columns_padding_0">
        <div class="container-fluid">
            <div class="row bottommargin_50 boxed-padding">
                <div class="col-lg-12 text-lg-right">
                    <h2 class="muellerhoff topmargin_5 bottommargin_50 highlight">VENTA DE FOTOS Y VÍDEOS</h2>
                </div>
            </div>
...
<script>
    export default {
        ...
        methods:{
            listarUsuarios (){
                let me=this;
                axios.get('/usuarios/venta').then(function (response) {
