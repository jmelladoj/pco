<template>
    <section id="valoradas" class="ds page_models models_square gorizontal_padding section_padding_70 columns_padding_0">
            <div class="container-fluid">
                <div class="row bottommargin_50 boxed-padding">
                    <div class="col-lg-12 text-lg-left">
                        <h2 class="muellerhoff topmargin_5 highlight">MEJOR VALORADAS</h2>
                    </div>
                </div>

                <div class="row bottommargin_50 boxed-padding form-group">
                    <div class="col-md-4">
                        <h4 class="muellerhoff topmargin_5 highlight">CRITERIO DE BUSQUEDA :</h4>
                    </div>
                    <div class="col-md-8">
                        <select v-model="filtrar" class="form-control" @change="filtrarUsuarios()">
                            <option value="0">VER TODO</option>
                            <option value="ROSTRO">MEJOR ROSTRO</option>
                            <option value="CUERPO">MEJOR CUERPO</option>
                            <option value="TRATO">MEJOR TRATO</option>
                            <option value="BESOS">MEJORES BESOS</option>
                            <option value="MOVIMIENTOS">MEJORES MOVIMIENTOS</option>
                            <option value="SEXO ORAL">MEJOR SEXO ORAL</option>
                            <option value="SEXO ANAL">MEJOR SEXO ANAL</option>
                            <option value="ORAL MUTUO">MEJOR ORAL MUTUO</option>
                            <option value="TRASERO">MEJOR TRASERO</option>
                            <option value="SENOS">MEJORES SENOS</option>
                            <option value="AMERICANA">MEJOR AMERICANA</option>
                            <option value="FOGOSA">FOGOSA</option>
                        </select>
                    </div>
                </div>

                <div class="isotope row masonry-layout bottommargin_20 altura">
                    <div v-for="usuario in filtrados" :key="usuario.id" class="isotope-item">
        ...
        methods:{
            ...
            filtrarUsuarios (){
                ...
                if(me.filtrar == 0){
                    ...
                    me.filtrados = me.usuarios.filter(function (u) {
                        return u.valoraciones[0] == me.filtrar;
                    });
                }
            }
        },
