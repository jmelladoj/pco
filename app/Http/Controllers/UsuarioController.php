...
class UsuarioController extends Controller
{
    ...
    public function crear(Request $request){
        ...
        if ($request->hasFile('imagen_perfil')) {
            ...
            ImageOptimizer::optimize('storage/' . $url, 'storage/' . $url);
    ...
    public function calificar(Request $request){
        ...
        $valoracion->disponibilidad = $datos_calificacion->disponibilidad;
        ...
        $valoracion->oral_mutuo = $datos_calificacion->oral_mutuo;
        $valoracion->trasero = $datos_calificacion->trasero;
        $valoracion->senos = $datos_calificacion->senos;
        $valoracion->americana = $datos_calificacion->americana;
        $valoracion->fogosa = $datos_calificacion->fogosa;
        $valoracion->save();
    }
